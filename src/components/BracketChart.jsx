              ...
              <div style={{ width: 136 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-around', height: bH }}>
                  {rMatches.map((match) => {
                    ...
                    const borderColor = match.winnerId ? '#86efac' : tbd ? '#d1d5db' : isPlayoff ? '#fcd34d' : '#bfdbfe';
                    const bg = match.winnerId ? '#f0fdf4' : tbd ? '#f9fafb' : isPlayoff ? '#fffbeb' : '#eff6ff';
                    ...
                    return (
                      ...
                      >
                        <div style={{ fontWeight: 600, fontSize: 11, color: match.winnerId === match.teamAId ? '#16a34a' : tbd ? '#9ca3af' : '#1e293b', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        ...
                        <div style={{ fontWeight: 600, fontSize: 11, color: match.winnerId === match.teamBId ? '#16a34a' : tbd ? '#9ca3af' : '#1e293b', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
